...
function TB_show(caption, url, rel) {
	...
	if ( !$("TB_overlay") )
	{
		...
		$('TB_load').innerHTML = "<img src='_includes/images/loading.gif' />";
		$("TB_load").setStyles({left: (window.getScrollLeft() + (window.getWidth() - /*56*/220)/2)+'px', top: (window.getScrollTop() + ((window.getHeight()-20)/2))+'px',display:"block"});
		//TB_load_position();
	...
	if ( baseURL.match(imageURL) ) {
		...
		if(url.indexOf('TB_iframe') != -1){				
			...
			$("TB_window").innerHTML += "<div id='TB_title'><div id='TB_ajaxWindowTitle'>"+caption+"</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='Close'><img src='_includes/images/icon-close-popup.gif' alt='Close' /></a></div></div><iframe frameborder='0' hspace='0' src='"+urlNoQuery[0]+"' id='TB_iframeContent' name='TB_iframeContent' style='width:"+(ajaxContentW + 29)+"px;height:"+(ajaxContentH + 17)+"px;' onload='TB_showWindow()'> </iframe>&nbsp;";
		} else {
